...
import { personalInfo, features } from "../../config";

export default function HeroSection() {
    return (
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background px-4 sm:px-8 pb-20 sm:pb-0">
            {/* Background Elements */}
